 ...
 */
export const generateDashboardThumbnail = async (uid: string, panelList: Panel[]) => {
 ...
 */
export const updatePanelThumbnailsWithApi = async (uidAndSlug: string, position: string) => {
 ...
 * @param panelList - The list of panels in the dashboard.
 */
export const updateAllThumbnails = async (uidAndSlug: string, panelList: Panel[]) => {
