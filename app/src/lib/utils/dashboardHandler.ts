 ...
 */
export function generateTags(tags: string): string[] {
 ...
 */
export function generatePanelFormJSON(panelForm: string, colCount: number): Panel[] {
 ...
 */
export function getUidAndSlug(resp: { uid: string; slug: string }): string {
